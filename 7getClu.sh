...
myHtmlFile="/var/www/html/logs/clucas/"$insti".html"
...
echo "</td></tr><tr><td><button class=button id=copy-button data-clipboard-target=#toCopy onclick=run()>Copy</button></td></tr></tbody></font></table>">>$myFile
