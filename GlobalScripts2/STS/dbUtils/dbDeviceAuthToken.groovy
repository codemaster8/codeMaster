...
class dbDeviceAuthToken extends dbUtils
{
	...
	*/
	def deviceAuthTokenGetRow(String oid) {
		...
		"IS_GENERATED " +
		"from DEVICE_AUTH_TOKEN where DEVICE_AUTH_TOKEN_OID = hextoraw('$oid')";
	...
	*/
	def deviceAuthTokenGetStatus(String oid) { 
		...
		this.sql = "SELECT STATUS as " +
			"STATUS FROM DEVICE_AUTH_TOKEN where DEVICE_AUTH_TOKEN_OID = hextoraw('" + oid + "')";
	...
	*/
	def deviceCreateDateTODdiff(String oid) { 
		...
		this.sql = "SELECT (extract(DAY FROM sysdate - CREATED_DATE)*24*60*60)+ " + 
			...
			"as sec FROM DEVICE_AUTH_TOKEN where DEVICE_AUTH_TOKEN_OID = hextoraw('" + oid + "')";
	...
	*/
	def deviceGetExpirationDate(String oid,String format = "STANDARD") { 
		...
		this.sql = "SELECT to_char(EXPIRATION_DATE, 'yyyy/mm/dd HH24:MI:SS') as " +
			"EXPIRATION_DATE FROM DEVICE_AUTH_TOKEN where DEVICE_AUTH_TOKEN_OID = hextoraw('" + oid + "')";
	...
	*/
	def deviceGetAuthCode(String oid) { 
		...
		this.sql = "SELECT DEVICE_AUTH_CODE as " +
			"DEVICE_AUTH_CODE FROM DEVICE_AUTH_TOKEN where DEVICE_AUTH_TOKEN_OID = hextoraw('" + oid + "')";
	...
	*/
	def deviceAuthSetStatus(String oid, String status) { 
		...
		this.sql = "UPDATE DEVICE_AUTH_TOKEN set STATUS = '" + status + "' where DEVICE_AUTH_TOKEN_OID = hextoraw('" + oid + "')";
	...
	*/
	def deviceAuthSetExpire(String oid, int minutes) { 
		...
		this.sql = "UPDATE DEVICE_AUTH_TOKEN set EXPIRATION_DATE = sysdate " + del + " where DEVICE_AUTH_TOKEN_OID = hextoraw('" + oid + "')";
	...
	*/
	def deviceAuthSetCreatedByNode(String oid, String node) { 
		...
		this.sql = "UPDATE DEVICE_AUTH_TOKEN set CREATED_BY_NODE_OID = '" + node + "' where DEVICE_AUTH_TOKEN_OID = hextoraw('" + oid + "')";
	...
	*/
	def deviceDeleteTokensByNodeOid(String oid) { 
		...
		this.sql = "DELETE FROM DEVICE_AUTH_TOKEN where CREATED_BY_NODE_OID = hextoraw('" + oid + "')";
	...
	*/
	def deviceDeleteTokensByAccountOid(String oid) { 
		...
		this.sql = "DELETE FROM DEVICE_AUTH_TOKEN where ACCOUNT_OID = hextoraw('" + oid + "')";
	...
	*/
	def deviceDeleteDeviceByAccount(String oid) { 
		...
		this.sql = "DELETE FROM DEVICE where ACCOUNT_OID = hextoraw('" + oid + "')";
	...
	*/
	def deviceAuthTokenCountByNode(String oid) { 
		...
		this.sql = "SELECT count(*) as CNT FROM DEVICE_AUTH_TOKEN where ACCOUNT_OID = hextoraw('" + oid + "')";
