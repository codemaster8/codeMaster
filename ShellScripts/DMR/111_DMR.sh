...
timeStampsFile='/opt/dece/timeStamps/timeStampsFile_111-'$regressionStartTime
projectPath='/opt/dece/GitRepo/uv-coordinator-api-regression/Projects/111/DMR'

echo "111 Projects Started at $currentTime" >> $timeStampsFile
...
currentTime=`date`
echo "111 Project1 Completed at $currentTime" >> $timeStampsFile
sleep 20
...
currentTime=`date`
echo "111 Project2 Completed at $currentTime" >> $timeStampsFile
sleep 20
...
currentTime=`date`
echo "111 Project3 Completed at $currentTime" >> $timeStampsFile
sleep 20
...
currentTime=`date`
echo "111 Project4 Completed at $currentTime" >> $timeStampsFile
sleep 20
...
currentTime=`date`
echo "111 Project5 Completed at $currentTime" >> $timeStampsFile
sleep 20
...
currentTime=`date`
echo "111 Project6 Completed at $currentTime" >> $timeStampsFile
sleep 20
...
currentTime=`date`
echo "111 Project7 Completed at $currentTime" >> $timeStampsFile
sleep 20
...
currentTime=`date`
echo "111 Project8 Completed at $currentTime" >> $timeStampsFile
sleep 20
...
currentTime=`date`
echo "111 Project9 Completed at $currentTime" >> $timeStampsFile
sleep 20
...
currentTime=`date`
echo "111 Project10 Completed at $currentTime" >> $timeStampsFile
