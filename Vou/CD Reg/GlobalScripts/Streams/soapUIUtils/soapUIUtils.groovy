...
{   
    ...
    def void setHTTPBasicAuthCredentials(RestTestRequestStep testStep, String userName, String passWord)
    {      
        try
        {  
            ...
            this.log.info "Done Setting Username for test step '" + testStep.name + "' to '" + userName + "' and password to '" + passWord + "'."                                
        }
        catch(Throwable e)
        {
            if (this.log) 
