...
class dbRightsToken extends dbUtils 
{
	...
	*/
	private dbSetStatusSQL(String rightstoken, String status) {
		this.sql = "update RIGHTS_TOKEN set STATUS_ID = '%%STATUS%%' where RIGHTS_TOKEN_OID = hextoraw('%%RT%%')";
...
/**
	...
	*/
		this.sql = "delete DISCRETE_MEDIA_TOKEN_HISTORY where RIGHTS_TOKEN_OID = hextoraw('" + rightstoken + "')";
	...
	*/
		this.sql = "delete DISCRETE_MEDIA_TOKEN where RIGHTS_TOKEN_OID = hextoraw('" + rightstoken + "')";
	...
	*/	
		...
		if (!rowDataXML.isEmpty()) {
			...
			// Delete PURCHASED_FULFILLMENT_METHOD
				...
				"PURCHASED_FULFILLMENT_MTHD_OID = hextoraw('" + oid + "')";
