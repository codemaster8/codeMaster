...
class dbUser extends dbUtils 
{
	...
	*/
	private dbSetStatusSQL(String user, String status) {
		this.sql = "update ACCOUNT_USER set STATUS = '%%STATUS%%' where USER_OID = '%%USER%%'"; 
	...
	*/
	def userSetLoginFailures(String oid, int value) { 
		...
		this.sql = "UPDATE ACCOUNT_USER set LOGIN_FAILURES = " + value + " where USER_OID = '" + oid + "'";	
