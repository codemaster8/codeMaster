    		...
    		catch(Throwable e) 
    		{
    			if(this.log) 
    			{
    				this.log.info e;   
                                ...
                                try 
                                {
                                                db = [url: 'jdbc:oracle:thin:@stdeqp-clu1-scan.va.neustar.com:2115/stdecqlp.neustar.com', user: dbUsername, password: dbPassword, driver: 'oracle.jdbc.driver.OracleDriver'];
                                                this.dbConn = Sql.newInstance(db.url, db.user, db.password, db.driver);
                                }
                                catch(Throwable e) 
                                {
                                ...
                                try 
                                {
                                                db = [url: 'jdbc:oracle:thin:@chdeqp-clu1-scan.nc.neustar.com:2115/chdecqlp.neustar.com', user: dbUsername, password: dbPassword, driver: 'oracle.jdbc.driver.OracleDriver'];
                                                this.dbConn = Sql.newInstance(db.url, db.user, db.password, db.driver);
                                }
                                catch(Throwable e) 
                                {
