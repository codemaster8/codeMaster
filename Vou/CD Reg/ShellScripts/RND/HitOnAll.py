...
for key in sorted(clusterName):
	...
	print machineName
        ...
        cluster_value = subprocess.Popen('sshpass -p "qauv13" ssh -o StrictHostKeyChecking=no -t QAUV@{0} {1}'.format(machineName, command), stdout=subprocess.PIPE, stderr=None, shell=True)
